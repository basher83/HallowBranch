name: "Python Base PRP Template - MCP Server Development"
description: |
**PYTHON-SPECIFIC**: This template is designed exclusively for Python-based MCP server development with FastAPI, Pydantic, and async patterns.
For Next.js/React/TypeScript development, use the TypeScript-specific templates instead.

## ⚠️ **NOT FOR NEXT.JS/REACT**: This template is Python-only and will not work with your current repository's tech stack.
...
**IMPORTANT**: This is a Python-specific template for MCP server development. If you're working with Next.js/React/TypeScript, use the TypeScript-specific templates instead.

_Before writing this PRP, validate: "If someone knew nothing about this Python MCP codebase, would they have everything needed to implement this successfully?"_
...
⚠️ **PYTHON ONLY**: These commands are for Python development and will not work with your Next.js repository.
...
## Final Validation Checklist (Python-Specific)

⚠️ **PYTHON ONLY**: This checklist is for Python MCP server development and does not apply to Next.js projects.
