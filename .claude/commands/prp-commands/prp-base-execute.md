---
description: Execute a base PRP for complete feature implementation in one pass
...
4. **Progressive Validation**
   ...
   **Repository-Specific Validation**: For Next.js/Supabase projects, expect commands like:

   - `cd nextjs && npx tsc --noEmit` (TypeScript compilation)
   - `cd nextjs && yarn lint` (ESLint validation)
   - `cd nextjs && yarn build` (Next.js build validation)
