---
description: Implement a Next.js/React/TypeScript feature using a PRP file within the Supabase SaaS Template repository
...
3. ## **Execute the plan**
   ...
   - Implement all the code using Next.js/Supabase patterns
   - Follow TypeScript/React best practices from existing codebase
   - Ensure proper type safety and error handling for Supabase operations
   - Follow existing repository patterns (SassClient, shadcn/ui components)
   - Use Next.js App Router conventions for routing
   - Leverage existing UI components from nextjs/src/components/ui/
